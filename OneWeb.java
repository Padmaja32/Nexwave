...
public static void main(String[] args) 
{
	...
	try {
		objprop.load(new FileInputStream("E:\\Deloitte\\data1.properties"));
	} catch (IOException e) {
	...
	WebElement Obj1= ObjDriver.findElement
			(By.xpath("//a[@href='https://demo.opencart.com/index.php?route=account/account']"));
	Obj1.click();
